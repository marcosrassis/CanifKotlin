...
/**
 * Created by Marcos on 13/10/2016.
 */
public class Dinheiro_4Fragment extends Fragment {
    ...
    private final TextWatcher textWatcher = new TextWatcher() {
        ...
        public void onTextChanged(CharSequence s, int start, int before, int count) {
            ...
            calculaCompra_4(deposito_mensal.getText().toString(), taxa_de_juros.getText().toString(), periodo.getText().toString(), valor_acumulado.getText().toString(), deposito_inicial);
        }
