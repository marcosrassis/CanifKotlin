...
import static com.assissoft.canif.simcalc.utils.FuncoesHelper.calculaEmprestimo_1;

/**
 * Created by Marcos on 05/10/2016.
 */
public class Emprestimo_1Fragment extends Fragment {
    ...
    private final TextWatcher textWatcher = new TextWatcher() {
        ...
        public void onTextChanged(CharSequence s, int start, int before, int count) {
            //after text changed
            calculaEmprestimo_1(taxa_de_juros.getText().toString(), numero_de_meses.getText().toString(), montante.getText().toString(), valor_do_emprestimo);
        }
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        valor_do_emprestimo = view.findViewById(R.id.et_valor_do_emprestimo);
        taxa_de_juros = view.findViewById(R.id.et_taxa_de_juros);
        numero_de_meses = view.findViewById(R.id.et_numero_de_meses);
        montante = view.findViewById(R.id.et_montante);
        ...
        valor_do_emprestimo.setEnabled(false);
