...
public class Dinheiro_2Fragment extends Fragment {
    ...
    private final TextWatcher textWatcher = new TextWatcher() {
        ...
        public void onTextChanged(CharSequence s, int start, int before, int count) {
            ...
            calculaCompra_2(deposito_inicial.getText().toString(), taxa_de_juros.getText().toString(), periodo.getText().toString(), valor_acumulado.getText().toString(), deposito_mensal);
        }
