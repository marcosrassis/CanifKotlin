...
import static com.assissoft.canif.simcalc.utils.FuncoesHelper.calculaCompra_1;

/**
 * Created by Marcos on 11/10/2016.
 */
public class Compra_1Fragment extends Fragment {
    ...
    private final TextWatcher textWatcher = new TextWatcher() {
        ...
        public void onTextChanged(CharSequence s, int start, int before, int count) {
            //after text changed
            calculaCompra_1(deposito_inicial.getText().toString(), deposito_mensal.getText().toString(), taxa_de_juros.getText().toString(), periodo.getText().toString(), valor_do_bem);
        }
