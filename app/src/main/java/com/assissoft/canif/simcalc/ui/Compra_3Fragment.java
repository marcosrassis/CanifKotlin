 ...
 */
public class Compra_3Fragment extends Fragment {
    ...
    private final TextWatcher textWatcher = new TextWatcher() {
        ...
        public void onTextChanged(CharSequence s, int start, int before, int count) {
            //after text changed
            calculaCompra_3(deposito_inicial.getText().toString(), deposito_mensal.getText().toString(), taxa_de_juros.getText().toString(), valor_do_bem.getText().toString(), periodo);
        }
