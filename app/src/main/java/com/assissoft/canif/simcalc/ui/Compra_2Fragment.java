 ...
 */
public class Compra_2Fragment extends Fragment {
    ...
    private final TextWatcher textWatcher = new TextWatcher() {
        ...
        public void onTextChanged(CharSequence s, int start, int before, int count) {
            //after text changed
            calculaCompra_2(deposito_inicial.getText().toString(), taxa_de_juros.getText().toString(), periodo.getText().toString(), valor_do_bem.getText().toString(), deposito_mensal);
        }
