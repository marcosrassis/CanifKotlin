...
import static com.assissoft.canif.simcalc.utils.FuncoesHelper.calculaRenda_1;

/**
 * Created by Marcos on 11/10/2016.
 */
public class Renda_1Fragment extends Fragment {
    ...
    private final TextWatcher textWatcher = new TextWatcher() {
        ...
        public void onTextChanged(CharSequence s, int start, int before, int count) {
            //after text changed
            calculaRenda_1(valor_acumulado.getText().toString(), taxa_de_juros.getText().toString(), periodo.getText().toString(), retirada);
        }
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        retirada = view.findViewById(R.id.et_retirada);
