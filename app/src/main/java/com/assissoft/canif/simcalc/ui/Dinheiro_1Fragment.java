 ...
 */
public class Dinheiro_1Fragment extends Fragment {
    ...
    private final TextWatcher textWatcher = new TextWatcher() {
        ...
        public void onTextChanged(CharSequence s, int start, int before, int count) {
            ...
            calculaCompra_1(deposito_inicial.getText().toString(), deposito_mensal.getText().toString(), taxa_de_juros.getText().toString(), periodo.getText().toString(), valor_acumulado);
        }
