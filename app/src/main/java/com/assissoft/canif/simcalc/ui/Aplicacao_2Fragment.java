...
import static com.assissoft.canif.simcalc.utils.FuncoesHelper.calculaAplicacao_2;

/**
 * Created by Marcos on 11/10/2016.
 */
public class Aplicacao_2Fragment extends Fragment {
    ...
    private final TextWatcher textWatcher = new TextWatcher() {
        ...
        public void onTextChanged(CharSequence s, int start, int before, int count) {
            //after text changed
            calculaAplicacao_2(valor_futuro.getText().toString(), taxa_de_juros.getText().toString(), periodo.getText().toString(), capital);
        }
