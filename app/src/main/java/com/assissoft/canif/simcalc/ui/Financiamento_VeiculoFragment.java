...
import static com.assissoft.canif.simcalc.utils.FuncoesHelper.calculaEntradaVeiculo;

/**
 * Created by Marcos on 10/10/2016.
 */
public class Financiamento_VeiculoFragment extends Fragment {
    ...
    private final TextWatcher textWatcher = new TextWatcher() {
        ...
        public void onTextChanged(CharSequence s, int start, int before, int count) {
            //after text changed
            calculaEntradaVeiculo(periodo.getText().toString(), valor_da_parcela.getText().toString(), preco_do_veiculo.getText().toString(), taxa_de_juros.getText().toString(), valor_financiado, valor_da_entrada);
        }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.simcalc_fin_veiculo, container, false);
