...
public class Simcalc_RV_Adapter extends RecyclerView.Adapter<Simcalc_RV_Adapter.MyViewHolder> {
    ...
    class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        MyViewHolder(View itemView) {
            ...
            tituloCalculo = itemView.findViewById(R.id.tv_title);
            descricaoCalculo = itemView.findViewById(R.id.tv_description);
            imagemCalculo = itemView.findViewById(R.id.iv_simcalc);
