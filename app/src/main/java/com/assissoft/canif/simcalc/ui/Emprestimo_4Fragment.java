...
import static com.assissoft.canif.simcalc.utils.FuncoesHelper.calculaEmprestimo_4;

/**
 * Created by Marcos on 05/10/2016.
 */
public class Emprestimo_4Fragment extends Fragment {
    ...
    private final TextWatcher textWatcher = new TextWatcher() {
        ...
        public void onTextChanged(CharSequence s, int start, int before, int count) {
            //after text changed
            calculaEmprestimo_4(numero_de_meses.getText().toString(), taxa_de_juros.getText().toString(), valor_do_emprestimo.getText().toString(), montante);
        }
