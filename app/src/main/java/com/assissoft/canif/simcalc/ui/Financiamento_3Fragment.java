...
import static com.assissoft.canif.simcalc.utils.FuncoesHelper.calculaFinanciamento_3;

/**
 * Created by Marcos on 10/10/2016.
 */
public class Financiamento_3Fragment extends Fragment {
    ...
    private final TextWatcher textWatcher = new TextWatcher() {
        ...
        public void onTextChanged(CharSequence s, int start, int before, int count) {
            //after text changed
            calculaFinanciamento_3(valor_da_parcela.getText().toString(), valor_financiado.getText().toString(), taxa_de_juros.getText().toString(), periodo, valorTotalPagar, valorGastoComJuros);
        }
