...
public class Financiamento_1Fragment extends Fragment {
    ...
    private final TextWatcher textWatcher = new TextWatcher() {
        ...
        public void onTextChanged(CharSequence s, int start, int before, int count) {
            //after text changed
            calculaFinanciamento_1(valor_da_parcela.getText().toString(), taxa_de_juros.getText().toString(), periodo.getText().toString(), valor_financiado, valorTotalPagar, valorGastoComJuros);
        }
