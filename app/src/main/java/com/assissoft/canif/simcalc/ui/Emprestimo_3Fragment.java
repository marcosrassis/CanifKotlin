...
import static com.assissoft.canif.simcalc.utils.FuncoesHelper.calculaEmprestimo_3;

/**
 * Created by Marcos on 05/10/2016.
 */
public class Emprestimo_3Fragment extends Fragment {
    ...
    private final TextWatcher textWatcher = new TextWatcher() {
        ...
        public void onTextChanged(CharSequence s, int start, int before, int count) {
            //after text changed
            calculaEmprestimo_3(montante.getText().toString(), taxa_de_juros.getText().toString(), valor_do_emprestimo.getText().toString(), numero_de_meses);
        }
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        numero_de_meses.setEnabled(false);
