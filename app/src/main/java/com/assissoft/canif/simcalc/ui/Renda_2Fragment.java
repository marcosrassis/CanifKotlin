...
import static com.assissoft.canif.simcalc.utils.FuncoesHelper.calculaRenda_2;

/**
 * Created by Marcos on 11/10/2016.
 */
public class Renda_2Fragment extends Fragment {
    ...
    private final TextWatcher textWatcher = new TextWatcher() {
        ...
        public void onTextChanged(CharSequence s, int start, int before, int count) {
            //after text changed
            calculaRenda_2(valor_acumulado.getText().toString(), taxa_de_juros.getText().toString(), retirada.getText().toString(), periodo);
        }
