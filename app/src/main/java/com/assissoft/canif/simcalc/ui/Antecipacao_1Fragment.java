...
public class Antecipacao_1Fragment extends Fragment implements DatePickerDialog.OnDateSetListener, DialogInterface.OnCancelListener {
    ...
    private final TextWatcher textWatcher = new TextWatcher() {
        ...
        public void onTextChanged(CharSequence s, int start, int before, int count) {
            ...
            if (obtemNumeroMeses() >= 0)
                FuncoesHelper.calculaAntecipacao_1(taxa_de_juros.getText().toString(), String.valueOf(obtemNumeroMeses()), valor_a_receber.getText().toString(), valor_atual, valor_do_desconto);
        }
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        valor_a_receber = view.findViewById(R.id.et_valor_a_receber);
        ...
        tvVencimento = view.findViewById(R.id.et_vencimento_parcela);
        tvDiaDoPagamento = view.findViewById(R.id.et_dia_pagamento);

        valor_a_receber.addTextChangedListener(textWatcher);
