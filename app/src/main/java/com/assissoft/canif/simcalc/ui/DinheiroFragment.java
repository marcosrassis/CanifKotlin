 ...
 */
public class DinheiroFragment extends Fragment implements RecyclerViewOnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        //return inflater.inflate(R.layout.simcalc_fragment,container,false);
        ...
        //Obtem a lista do menu Juntar Dinheiro do Simcalc
        List<Calculo> mList = listasHelper.getDinheiroList(getActivity());
    ...
    public void onItemClick(int position) {
        fs.chamaCalculoDinheiroSelecionado(position);
    }
