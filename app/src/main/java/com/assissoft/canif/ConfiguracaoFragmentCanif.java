...
public class ConfiguracaoFragmentCanif extends Fragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        ViewGroup ll_numero_casas_decimais = view.findViewById(R.id.ll_numero_casas_decimais);
        ViewGroup ll_contato = view.findViewById(R.id.ll_contato);
        ViewGroup ll_sobre = view.findViewById(R.id.ll_sobre);

        Switch mySwitch = view.findViewById(R.id.sw_status_notacao_cientifica);
