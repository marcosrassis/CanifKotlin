...
public class Conversor_RV_Adapter extends RecyclerView.Adapter<Conversor_RV_Adapter.MyViewHolder> {
    ...
    class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        MyViewHolder(View itemView) {
            ...
            tituloConversor = itemView.findViewById(R.id.tv_title);
            descricaoConversor = itemView.findViewById(R.id.tv_description);
            imagemConversor = itemView.findViewById(R.id.iv_conversor);
