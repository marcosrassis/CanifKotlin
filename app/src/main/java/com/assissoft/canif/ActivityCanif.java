...
public class ActivityCanif extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener, ConversorFragmentComunicator, SimcalcFragmentComunicator, GeralFragmentComunicator {
    ...
    private void fabAction() {
        ...
        if (fm != null && fm.isVisible()) {
            ...
            TextView tvPara = findViewById(R.id.tvPara);
            EditText etMontante = findViewById(R.id.etMontante);
            ...
            if (lc.cotacoes.size() > 0) {
                ...
                resultado = funcoesHelper.resultadoConversaoMoeda(TextoHelper.extraiSigla(tvDe.getText().toString()), TextoHelper.extraiSigla(tvPara.getText().toString()), etMontante.getText().toString());
        ...
        if (fr != null && fr.isVisible()) {
            ...
            TextView etRelatorio = findViewById(R.id.et_report);
    ...
    private void inverteConvercao() {
        ...
        if (DefConversor.TAXAS.equals(TAG))
            resultado = ConverteUnidadeHelper.calculaEquivTaxas(TextoHelper.extraiSigla(tvDe.getText().toString()) + "-" + TextoHelper.extraiSigla(tvPara.getText().toString()), etMontante.getText().toString());
        else if (DefConversor.TEMPERATURA.equals(TAG))
            resultado = ConverteUnidadeHelper.calculaTemperatura(TextoHelper.extraiSigla(tvDe.getText().toString()) + "-" + TextoHelper.extraiSigla(tvPara.getText().toString()), etMontante.getText().toString());
        else
            resultado = ConverteUnidadeHelper.calcula(TAG, TextoHelper.extraiSigla(tvDe.getText().toString()) + "-" + TextoHelper.extraiSigla(tvPara.getText().toString()), etMontante.getText().toString());
    ...
    private void chamaConversaoTodasUnidades() {
        ...
        args.putDouble("Montante", Double.valueOf(etMontante.getText().toString()));
