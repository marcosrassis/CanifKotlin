...
public class SobreFragmentCanif extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        TextView titleTextView = view.findViewById(R.id.tv_numero_versao_app);
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        ViewGroup ll_desenvolvedor_app = view.findViewById(R.id.ll_desenvolvedor_app);
        ViewGroup ll_descricao_app = view.findViewById(R.id.ll_descricao_app);
        ViewGroup ll_contato = view.findViewById(R.id.ll_contato);
        ViewGroup ll_observacao = view.findViewById(R.id.ll_observacao);
